...
I18N = {
    "pl": {
        ...
        "temperature_start_short": "Temp. początkowa [°C]",
        "temperature_end": "Temperatura końcowa [°C]",
        "temperature_end_short": "Temp. końcowa [°C]",
        ...
        "settings_currency_refresh_now": "Odśwież teraz",
        "settings_currency_cache_hint": "Zapisane kursy są używane przez 6 godzin od pobrania. „Odśwież teraz” pomija ten czas. Obie opcje pobierania wymagają włączonej aktualizacji kursów.",
        ...
        "nav_valves": "Zawory",
        "nav_labor": "Robocizna",
        "accessibility_screen_summary": "Refrigeration Calc. Aktualna karta: {screen}. {instructions}",
        "accessibility_screen_changed": "Otwarto kartę: {screen}.",
        "accessibility_freezing_instructions": "Wybierz produkt, podaj masę, temperatury i czas, a następnie użyj przycisku Oblicz.",
        "accessibility_valves_instructions": "Podaj parametry komory i chłodnic, a następnie użyj przycisku Oblicz zawory.",
        "accessibility_labor_instructions": "Podaj skład ekipy, czas i koszty organizacyjne, a następnie użyj przycisku Oblicz robociznę.",
        ...
        "labor_distance_short": "Odległość [km]",
    ...
    "en": {
        ...
        "temperature_start_short": "Initial temp. [°C]",
        "temperature_end": "Final temperature [°C]",
        "temperature_end_short": "Final temp. [°C]",
        ...
        "settings_currency_refresh_now": "Refresh now",
        "settings_currency_cache_hint": "Saved rates are reused for 6 hours after download. Refresh now bypasses this interval. Both download options require rate updates to be enabled.",
        ...
        "nav_valves": "Valves",
        "nav_labor": "Labor",
        "accessibility_screen_summary": "Refrigeration Calc. Current tab: {screen}. {instructions}",
        "accessibility_screen_changed": "Opened tab: {screen}.",
        "accessibility_freezing_instructions": "Choose a product, enter mass, temperatures and time, then use the Calculate button.",
        "accessibility_valves_instructions": "Enter chamber and cooler parameters, then use the Calculate valves button.",
        "accessibility_labor_instructions": "Enter crew, time and site costs, then use the Calculate labor button.",
        "labor_title": "Labor",
        ...
        "labor_distance_short": "Distance [km]",
