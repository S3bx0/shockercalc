...
_PRODUCT_LABELS_EN_EXACT = {
    ...
    "Pigwy": "Quinces",
    "Pomarańcze": "Oranges",
    "Porzeczka czarna": "Black currants",
    "Rodzynki": "Raisins",
    ...
    "Ogórki": "Cucumbers",
    "Okra": "Okra",
    "Papryka (słodka, główna odmiana)": "Sweet pepper",
    "Papryka liofilizowana": "Freeze-dried pepper",
    "Pasternak": "Parsnip",
    "Pietruszka": "Parsley",
    ...
    "Wołowina, udziec, pełny kawałek, chudy i tłusty": "Beef round, whole cut, lean and fat",
    "Wołowina, udziec, pełny kawałek, chudy": "Beef round, whole cut, lean",
    ...
    "Udziec jagnięcy, chudy": "Lamb leg, lean",
    "Masło": "Butter",
    "Camembert": "Camembert",
    "Cheddar": "Cheddar",
    "Gouda": "Gouda",
    ...
    "Serek wiejski, bez śmietany": "Cottage cheese, no cream",
...
def _build_product_labels_en() -> dict[str, str]:
    ...
    for products in catalog.values():
        for product in products:
            name = product.nazwa
            labels[name] = _PRODUCT_LABELS_EN_EXACT.get(name, name.replace("_", " "))
    return labels


PRODUCT_LABELS_EN = _build_product_labels_en()
...
def display_product(language: str, product: str | None) -> str:
    """Return the display label for a product in the given language."""
    if not product:
        return ""
    if language == "en":
        return PRODUCT_LABELS_EN.get(product, product.replace("_", " "))
